...
<!--
 ...
 $Id: api_to_java.xslt,v 1.145 2012/03/15 21:07:39 agoubard Exp $
...
public final class CAPI extends org.xins.client.AbstractCAPI {
    ...
    */
   private static java.util.HashMap initErrorCodesPerFunction() {
    ...
    *    invalid.
    */
   public CAPI(java.util.Map<String, String> properties, String apiName)
   throws IllegalArgumentException,
          org.xins.common.collections.MissingRequiredPropertyException,
          org.xins.common.collections.InvalidPropertyValueException {
   ...
   public </xsl:text>
		...
		<xsl:if test="input/data/element">
			...
			<xsl:text>org.w3c.dom.Element _dataSection</xsl:text>
		</xsl:if>
		<xsl:text>)
   throws </xsl:text>
		<xsl:call-template name="throws-exceptions">
      ...
      java.util.Map<String, String> params = new java.util.HashMap<String, String>();]]></xsl:text>
