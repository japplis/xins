...
<!--
 ...
 $Id: function_to_result_java.xslt,v 1.39 2012/04/16 19:40:39 agoubard Exp $
...
extends org.xins.client.AbstractCAPICallResult {</xsl:text>
    ...
    */
   private final org.w3c.dom.Element _dataElement;]]></xsl:text>
		</xsl:if>
    ...
    */
   public org.w3c.dom.Element dataElement() {
      return _dataElement;
   }]]></xsl:text>
		</xsl:if>
