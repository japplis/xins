...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xd:doc type="stylesheet">
    ...
    <xd:cvsId>$Id: stylesheet.xsl,v 1.1 2006/01/13 09:42:00 tauseef442 Exp $</xd:cvsId>
          ...
          <div class="propertyContent">
              <xsl:for-each select="xsl:param">
                ...
                <div class="parameterDetail">
                  ...
                  <span class="paramDescr"> - <xsl:apply-templates select="$doc/xd:param[@name=current()/@name]" mode="XdocTags"/></span>
                </div>
              </xsl:for-each>
          </div>
        </div>
