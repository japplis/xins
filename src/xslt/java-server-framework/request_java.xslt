...
<!--
 ...
 $Id: request_java.xslt,v 1.66 2012/04/16 19:40:39 agoubard Exp $
...
<xsl:text><![CDATA[
   ...
   public static final class Request implements java.io.Serializable {
      ...
      /**
       * The bag pack of the request.
       */
      private final java.util.Map<String, Object> __backpack;]]></xsl:text>
       ...
       */
      private final org.w3c.dom.Element __dataSection;</xsl:text>
		</xsl:if>
       ...
       *
       * @return
       *    the bag pack, never <code>null</code>.
       */
      public final java.util.Map<String, Object> backpack() {
         return __backpack;
      }]]></xsl:text>
	...
	<xsl:template name="constructor_request">
       ...
       */
      public Request(java.util.Map<String, Object> __backpackArg]]></xsl:text>
		...
		<xsl:if test="input/data/element">
			<xsl:text>,
                     org.w3c.dom.Element _dataSection</xsl:text>
		</xsl:if>
		<xsl:text>) {
         __backpack = __backpackArg;</xsl:text>
		<xsl:for-each select="input/param">
			<xsl:variable name="javaVariable">
				<xsl:call-template name="hungarianLower">
					<xsl:with-param name="text" select="@name" />
   ...
   public java.util.List</xsl:text>
      ...
      org.xins.common.xml.ElementList elements = new org.xins.common.xml.ElementList(</xsl:text>
		<xsl:value-of select="$dataSectionField" />
		<xsl:text>, "</xsl:text>
		<xsl:value-of select="@name" />
		<xsl:text>");
      java.util.List resultList = new java.util.ArrayList(elements.size());
      for (org.w3c.dom.Element nextElement : elements) {
         </xsl:text>
		<xsl:value-of select="$objectName" />
   ...
   public static final class </xsl:text>
       ...
       */
      private final org.w3c.dom.Element _element;
       ...
       */
		...
		<xsl:value-of select="$objectName" />
		<xsl:text>(org.w3c.dom.Element element) {
         _element = element;
      }
</xsl:text>
   ...
   public java.util.List</xsl:text>
      ...
      org.xins.common.xml.ElementList elements = new org.xins.common.xml.ElementList(_element, "</xsl:text>
