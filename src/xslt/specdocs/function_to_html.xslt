...
<!--
 ...
 $Id: function_to_html.xslt,v 1.121 2013/01/12 16:37:02 agoubard Exp $
	...
	<xsl:template match="function">
		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			...
			<body>
				...
				<!-- Cache -->
				<xsl:if test="@cache">
					<p><em>The successful result of this function can be cached <xsl:value-of select="@cache" /> seconds.</em></p>
				</xsl:if>
