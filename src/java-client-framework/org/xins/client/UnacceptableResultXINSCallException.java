/*
 * $Id: UnacceptableResultXINSCallException.java,v 1.27 2012/02/28 18:10:54 agoubard Exp $
 *
 ...
 * exception is thrown.
 *
 * @version $Revision: 1.27 $ $Date: 2012/02/28 18:10:54 $
...
extends XINSCallException {
   ...
   throws IllegalArgumentException {
      Map<String, String> p = getParameters();
      if (p == null) {
         return null;
      } else {
         return p.get(name);
