/*
 * $Id: EngineStarter.java,v 1.56 2013/01/02 13:05:56 agoubard Exp $
 *
 ...
 * XINS engine starter.
 *
 * @version $Revision: 1.56 $ $Date: 2013/01/02 13:05:56 $
...
final class EngineStarter {
   ...
   /**
    * The name of the bootstrap property that specifies the version with which the API was built.
    */
   ...
   /**
    * Write messages to logs for API running on old systems.
    */
   ...
   Map<String, String> bootstrap(API api) throws ServletException {
      ...
      // Convert ServletConfig to Map<String, String>
