/*
 * $Id: AccessRule.java,v 1.52 2012/02/28 18:10:54 agoubard Exp $
 *
 ...
 * </dl>
 *
 * @version $Revision: 1.52 $ $Date: 2012/02/28 18:10:54 $
...
public final class AccessRule implements AccessRuleContainer {
   ...
   throws IllegalStateException, IllegalArgumentException, ParseException {
      ...
      if (_ipFilter.match(ip)) {
         ...
         if (_functionNameRegex.matcher(functionName).matches() &&
               (conventionName == null || _conventionNameRegex.matcher(conventionName).matches())) {
