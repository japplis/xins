/*
 * $Id: ChainedMap.java,v 1.22 2012/03/03 10:41:19 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.22 $ $Date: 2012/03/03 10:41:19 $
...
public class ChainedMap extends AbstractMap implements Cloneable, Serializable {
    ...
    */
   private List<EntryMap> _entries = new ArrayList<EntryMap>();
