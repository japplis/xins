/*
 * $Id: CreateExampleTask.java,v 1.22 2011/01/19 18:13:39 agoubard Exp $
 *
 ...
 * on the request URL.
 *
 * @version $Revision: 1.22 $ $Date: 2011/01/19 18:13:39 $
...
public class CreateExampleTask extends Task {
   ...
   /**
    * The document used to create and hold the XML element.
    */
