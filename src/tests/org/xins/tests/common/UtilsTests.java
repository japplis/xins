/*
 * $Id: UtilsTests.java,v 1.24 2013/01/02 09:35:35 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.24 $ $Date: 2013/01/02 09:35:35 $
...
public class UtilsTests extends TestCase {
   ...
   public void testLogProgrammingErrorWithArguments() {
      ...
      assertTrue("Incorrect cause for ProgrammingException.", ExceptionUtils.getRootCause(pe) == e);
