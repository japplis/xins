/*
 * $Id: BeanUtilsTests.java,v 1.16 2011/01/19 18:13:39 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.16 $ $Date: 2011/01/19 18:13:39 $
...
public class BeanUtilsTests extends TestCase {
   ...
   public void testXmlToObject1() throws Exception {
      Element element1 = ElementFormatter.createMainElement("simplePojo");
   ...
   public void testXmlToObject2() throws Exception {
      Element element1 = ElementFormatter.createMainElement("pojo");
      element1.setAttribute("simpleInt", "33");
      element1.setAttribute("almostBoolean", "true");
