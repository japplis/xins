/*
 * $Id: HexConverterTests.java,v 1.19 2011/02/12 08:22:46 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.19 $ $Date: 2011/02/12 08:22:46 $
...
public class HexConverterTests extends TestCase {
   ...
   public void testToHexString_byteArray() throws Throwable {
      ...
      input1 = new byte[0];
      assertEquals("", HexConverter.toHexString(input1));
