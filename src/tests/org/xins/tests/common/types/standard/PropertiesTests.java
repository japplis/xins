/*
 * $Id: PropertiesTests.java,v 1.20 2010/11/18 20:35:05 agoubard Exp $
 *
...
public class PropertiesTests extends TestCase {
   ...
   public void testFromString() throws Throwable {
      ...
      Map<String, String> pr = (Map<String, String>) TYPE.fromString("");
      assertTrue(! pr.keySet().iterator().hasNext());
      ...
      pr = (Map<String, String>) TYPE.fromString(string);
