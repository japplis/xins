/*
 * $Id: XINSCallResultParserTests.java,v 1.40 2012/03/15 21:07:39 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.40 $ $Date: 2012/03/15 21:07:39 $
...
public class XINSCallResultParserTests extends TestCase {
   ...
   public void testParseXINSCallResult1() throws Exception {
      ...
      assertEquals("data", dataElement.getTagName());

      // There should be no attributes in the root element
      assertEquals(0, dataElement.getAttributes().getLength());
      ...
      /* XINS 3.0: Not checked anymore as dom doesn't have methods for it
   ...
   public void testParseXINSCallResult2() throws Exception {
      ...
      Map<String, String> params = result3.getParameters();
   ...
   public void verifyCorrectResult(XINSCallResultData result) throws Exception {
      ...
      assertTrue(params == null || params.isEmpty());
      ...
      NamedNodeMap childOneAttr = childOne.getAttributes();
      assertEquals(2, childOneAttr.getLength());
      ...
      NamedNodeMap childTwoAttr = childTwo.getAttributes();
      assertEquals(2, childTwoAttr.getLength());
   ...
   public void testParseXINSCallResult5() throws Exception {
      ...
      assertEquals("result", child.getTagName());
      child = (Element) children.get(1);
      assertEquals("data", child.getTagName());
   }
   ...
   public void testParseXINSCallResult6() throws Exception {
      ...
      // Result element with namespace should not be accepted
      /* XINS 3.0: getNamespaceURI() with DOM returns null
