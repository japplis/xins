/*
 * $Id: XSLTCallingConventionTests.java,v 1.10 2010/11/18 20:35:05 agoubard Exp $
 *
...
public class XSLTCallingConventionTests extends TestCase {
   ...
   private String getHTMLVersion(boolean useTemplateParam) throws Exception {
      ...
      params.put("_function", "_GetVersion");
      params.put("_convention", "_xins-xslt");
      if (useTemplateParam) {
         params.put("_template", "src/tests/getVersion2.xslt");
      }
