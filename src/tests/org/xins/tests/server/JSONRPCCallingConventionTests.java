/*
 * $Id: JSONRPCCallingConventionTests.java,v 1.9 2010/10/25 20:36:51 agoubard Exp $
 *
 ...
 *
 * @version $Revision: 1.9 $ $Date: 2010/10/25 20:36:51 $
...
public class JSONRPCCallingConventionTests extends TestCase {
   ...
   public void testJSONRPCCallingConventionGet() throws Throwable {
      ...
      params.put("_convention", "_xins-jsonrpc");
      params.put("useDefault", "false");
      params.put("inputText", randomFive);
