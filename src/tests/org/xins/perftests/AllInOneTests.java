/*
 * $Id: AllInOneTests.java,v 1.34 2013/01/28 17:58:50 agoubard Exp $
 *
 ...
 *
 * XINS 2.3 performance performanceAllInOne: 0.935 second
 * XINS 3.0 performance performanceAllInOne: 1.472 second
 * XINS 3.1 performance performanceAllInOne: 1.273 second
 *
 * @version $Revision: 1.34 $ $Date: 2013/01/28 17:58:50 $
...
public class AllInOneTests extends TestCase {
    ...
    *    in case of an error.
    */
   public void testPerformanceAllInOne() throws Exception {
      doTestAllInOne(true);
   }

   public void testOverheadAllInOne() throws Exception {
